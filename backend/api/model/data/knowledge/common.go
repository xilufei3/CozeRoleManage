...
type ChunkStrategy struct {
	...
	// Split mode: simple, regex, langchain, lmchunker
	SplitMode *string `thrift:"split_mode,6,optional" form:"split_mode" json:"split_mode,omitempty" query:"split_mode"`
	...
	// Regex pattern for regex split mode
	RegexPattern *string `thrift:"regex_pattern,11,optional" form:"regex_pattern" json:"regex_pattern,omitempty" query:"regex_pattern"`
	// LangChain splitter type
	LangchainType *string `thrift:"langchain_type,12,optional" form:"langchain_type" json:"langchain_type,omitempty" query:"langchain_type"`
	// LMChunker method (0: PPL, 1: MS, 2: LUMBER_MS)
	LmchunkerMethod *int32 `thrift:"lmchunker_method,13,optional" form:"lmchunker_method" json:"lmchunker_method,omitempty" query:"lmchunker_method"`
}
...
var ChunkStrategy_LmchunkerMethod_DEFAULT int32

func (p *ChunkStrategy) GetLmchunkerMethod() (v int32) {
	if !p.IsSetLmchunkerMethod() {
		return ChunkStrategy_LmchunkerMethod_DEFAULT
	}
	return *p.LmchunkerMethod
}
...
func (p *ChunkStrategy) IsSetLmchunkerMethod() bool {
	return p.LmchunkerMethod != nil
}
...
func (p *ChunkStrategy) ReadField11(iprot thrift.TProtocol) error {
	...
	p.RegexPattern = _field
	return nil
}
func (p *ChunkStrategy) ReadField12(iprot thrift.TProtocol) error {
	...
	p.LangchainType = _field
	return nil
}
func (p *ChunkStrategy) ReadField13(iprot thrift.TProtocol) error {
...
func (p *ChunkStrategy) writeField11(oprot thrift.TProtocol) (err error) {
	if p.RegexPattern != nil {
		if err = oprot.WriteFieldBegin("regex_pattern", thrift.STRING, 11); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.RegexPattern); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *ChunkStrategy) writeField12(oprot thrift.TProtocol) (err error) {
	if p.LangchainType != nil {
		if err = oprot.WriteFieldBegin("langchain_type", thrift.STRING, 12); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteString(*p.LangchainType); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
...
func (p *ChunkStrategy) writeField13(oprot thrift.TProtocol) (err error) {
	if p.IsSetLmchunkerMethod() {
		if err = oprot.WriteFieldBegin("lmchunker_method", thrift.I32, 13); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteI32(int32(*p.LmchunkerMethod)); err != nil {
			return err
		}
		if err = oprot.WriteFieldEnd(); err != nil {
			goto WriteFieldEndError
