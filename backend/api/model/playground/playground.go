...
type CreateSpaceUserRequest struct {
	...
	SpaceRole int32  `thrift:"spaceRole,3,required" json:"spaceRole"`
}

func (p *CreateSpaceUserRequest) GetPassword() (v string) {
	return p.Password
}

func (p *CreateSpaceUserRequest) GetEmail() (v string) {
	return p.Email
}

func (p *CreateSpaceUserRequest) GetSpaceRole() (v int32) {
	return p.SpaceRole
}
...
type PlaygroundService interface {
	...
	CreateSpaceUser(ctx context.Context, request *CreateSpaceUserRequest) (r *CreateSpaceUserResponse, err error)
