...
import "github.com/coze-dev/coze-studio/backend/crossdomain/agentrun/model"
...
type RunRecord struct {
	...
	Usage          *model.Usage `gorm:"column:usage;comment:usage;serializer:json" json:"usage"`                                                                                           // usage
}
