...
type NodeExecution struct {
	...
	CompositeNodeIndex int64  `gorm:"column:composite_node_index;comment:loop or batch_s execution index" json:"composite_node_index"`                               // loop or batch_s execution index
	...
	ParentNodeID       string `gorm:"column:parent_node_id;comment:when as inner node for loop or batch, this is the parent node_s key" json:"parent_node_id"`       // when as inner node for loop or batch, this is the parent node_s key
