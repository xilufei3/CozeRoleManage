...
type nodeExecution struct {
	...
	CompositeNodeIndex field.Int64  // loop or batch_s execution index
	CompositeNodeItems field.String // the items extracted from parent composite node for this index
	ParentNodeID       field.String // when as inner node for loop or batch, this is the parent node_s key
